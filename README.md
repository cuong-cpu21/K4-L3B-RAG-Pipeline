...
- Mỗi thành viên nộp báo cáo cá nhân theo template trong `reports/INDIVIDUAL_REPORT.md` (lưu tại `reports/<student-id>-<short-name>.md`).
...
- [Individual report](reports/INDIVIDUAL_REPORT.md): template báo cáo cá nhân (nộp vào `reports/<student-id>-<short-name>.md`).
